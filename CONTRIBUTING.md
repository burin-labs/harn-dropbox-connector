# Contributing to harn-dropbox-connector

This repository does not accept external contributions.

## Why

`harn-dropbox-connector` is a generated and fleet-managed connector package. It carries the
Dropbox side of the Harn connector contract and almost nothing else. Its
...
- Found a bug in how this connector handles Dropbox, or want a connector that
